...
# This is a fork of DSVW from stamparm/DSVW used to demonstrate a vulnerable web application
# for CIS3367 course material. This extremely vulnerable web application has been modified
# to need to run as 'root' user, listen on the network interface, and on port 80.
#
# To use this application, from a root console type:
# 
#  [root@localhost ~]#  python dsvw.py
#
